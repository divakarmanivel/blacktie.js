...
function createCustomConfirm(txt) {
	...
	okBtn.onclick = "#";
	okBtn.focus();
	okBtn.onclick = function() { removeCustomAlert("confirmModalContainer"); return false; }
	...
	cancelBtn.onclick = "#";
	cancelBtn.focus();
	cancelBtn.onclick = function() { removeCustomAlert("confirmModalContainer"); return false; }
